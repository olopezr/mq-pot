...
1. Change	*TARGET_NAMESPACE* to your assigned project/namespace. **The value *VERSION* must be 9.2.4.0-r1**. Change **00** in *QMname* export to your student number. The value for *SC* export should be set to **ocs-storagecluster-ceph-rbd**.
